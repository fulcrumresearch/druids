...
# SSH in and install project dependencies
...
```bash
druids exec basher --devbox owner/repo task_name="test" task_spec="Hello world"
```
...
That is all you need. The rest of this document covers running Druids locally.
