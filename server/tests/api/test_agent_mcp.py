...
class TestMCPNoAuth:
    ...
    def test_no_auth_header_returns_empty_tools(self, mock_user, mock_execution):
        registry = get_executions_registry()
        registry.clear()
        user_id = str(mock_user.id)
        registry[user_id] = {mock_execution.slug: mock_execution}
    ...
    def test_invalid_token_returns_empty_tools(self, mock_user, mock_execution):
        registry = get_executions_registry()
        registry.clear()
        user_id = str(mock_user.id)
        registry[user_id] = {mock_execution.slug: mock_execution}
    ...
    def test_nonexistent_execution_returns_empty_tools(self, mock_user, mock_execution):
