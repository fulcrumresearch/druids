...
async def get_or_create_user(db: AsyncSession, github_id: int, github_login: str | None = None) -> User:
    """Get existing user by github_id or create new one. Updates github_login if changed."""
