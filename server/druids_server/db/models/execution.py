...
class ExecutionRecord(SQLModel, table=True):
    ...
    agents: list = Field(default_factory=list, sa_column=sa.Column(sa.JSON, default=list))
    edges: list = Field(default_factory=list, sa_column=sa.Column(sa.JSON, default=list))
