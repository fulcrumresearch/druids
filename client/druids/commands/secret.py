...
def set_secret(
    ...
    Single: druids secret set API_KEY sk-123 --devbox mybox
    From file: druids secret set --file .env --devbox mybox
    From stdin: echo sk-123 | druids secret set API_KEY --devbox mybox
    """
    client = _get_client()
