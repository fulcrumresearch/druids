...
async def program(ctx, spec="", task_name="", repo_full_name=""):
    ...
    def get_state():
        ...
        return {
            ...
            "max_rejections": MAX_AUDIT_ROUNDS,
            "task_name": task_name or "Build task",
            "agents": agents,
        }
    ...
    async def on_submit(summary: str = ""):
        ...
        nonlocal phase
        phase = "auditing"
        await ctx.emit("submitted_for_audit", {"round": rejections + 1})
        await auditor.send(
    ...
    async def on_approve(summary: str = ""):
        ...
        nonlocal phase
        phase = "complete"
        await ctx.emit("build_approved", {"summary": summary})
    ...
    async def on_feedback(feedback: str = ""):
        ...
        nonlocal rejections, phase
        rejections += 1
        phase = "building"
        await ctx.emit("audit_rejected", {"round": rejections, "max_rounds": MAX_AUDIT_ROUNDS})
